                ...
                <div class="jumbotron fondo-pantone-azul-claro">
                    ...
                    $_GET["ID-participacion"], $_GET["ID-turno"])) {
                        ...
                        if(!$aplicacion_filtros) {
                            ...
                            $estadisticas_carreras = $conexion_base->query("SELECT * FROM cantidad_colaboradores_carreras ORDER BY nombre_carrera = 'Todas las carreras registradas', 
                            cantidad_colaboradores, nombre_carrera;");

                            # Obtener el conteo de cuántos colaboradores hay por modalidad.
                            $estadisticas_modalidades = $conexion_base->query("SELECT * FROM cantidad_colaboradores_modalidades ORDER BY nombre_modalidad = 'Todas las modalidades',
                            cantidad_colaboradores, nombre_modalidad;");

                            # Obtener el conteo de cuántos colaboradores hay por tipo de participación.
                            $estadisticas_participaciones = $conexion_base->query("SELECT * FROM cantidad_colaboradores_participaciones ORDER BY nombre_participacion = 'Todos los tipos de participación', 
                            cantidad_colaboradores, nombre_participacion;");
                            ...
                            nombre_turno = 'Todos los turnos', cantidad_colaboradores ASC, nombre_turno;");
                        }
                        else {

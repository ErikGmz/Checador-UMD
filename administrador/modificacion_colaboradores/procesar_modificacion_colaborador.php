<?php
    ...
    $_POST["anterior-ID-colaborador"])) {
        ...
        # a otro colaborador ya existente en el sistema.
        try {
                    ...
                    || $tiempo_salida > date("1970-01-01 21:00")) {
                        ...
                        '" . $_POST["hora-entrada"] . "' AND hora_final = '" . $_POST["hora-salida"] . "';")) {
                            ...
                            try {
                                ...
                                . "ID_horario = '$ID_horario' WHERE ID = " . $_POST["anterior-ID-colaborador"]) . ";") {
                                    $resultado = 4;
            ...
            switch(estadoInicioSesion) {
                case 1:
                    window.addEventListener("load", () => {
                        Swal.fire({
                            icon: "error",
                            title: "Modificación no exitosa de colaborador",
                            text: "Ocurrió un error al tratar de modificar el colaborador"
                        }).then((resultado) => {
                ...
                case 2:
                    window.addEventListener("load", () => {
                        Swal.fire({
                            ...
                            text: "El nuevo ID del colaborador no puede ser uno ya existente"
                        }).then((resultado) => {
                            location.href="modificacion_colaborador.php";
                        });
                    });
                ...
                case 4:
                    window.addEventListener("load", () => {
                        Swal.fire({
                            icon: "success",
                            title: "Modificación exitosa de colaborador",
                            html: <?php echo "\"<p class='mb-4'> El siguiente colaborador fue exitosamente modificado en el sistema: </p> \\n"
